...
type rlpSubscriptionLog struct {
...
func (s SubscriptionLog) toRlpEncodable() rlpSubscriptionLog {
	...
	r := rlpSubscriptionLog{rlpLog, rlpReorg}
	return r
}

func (r rlpSubscriptionLog) toNormal() SubscriptionLog {
