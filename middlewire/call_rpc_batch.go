...
type BatchCallRpcMiddleWire func(BatchCallRpcHandler) BatchCallRpcHandler

func (brh BatchCallRpcHandlerFunc) Handle(b []rpc.BatchElem) error {
	return brh(b)
}

func BatchCallRpcLogMiddleWire(handler BatchCallRpcHandler) BatchCallRpcHandler {
