...
func main() {
	...
	utils.PanicIfErrf(err, "failed to get data")
	...
	utils.PanicIfErrf(err, "failed to get balance")
	...
	utils.PanicIfErrf(err, "failed to transfer")
	...
	utils.PanicIfErrf(err, "failed to get tx receipt")
	...
	utils.PanicIfErrf(err, "failed to decode event")
