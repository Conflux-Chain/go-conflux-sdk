...
type ContractCaller interface {
	...
	GetCode(address types.Address, epoch ...*types.EpochOrBlockHash) (code hexutil.Bytes, err error)
	// ContractCall executes an Ethereum contract call with the specified data as the
	// input.
	Call(call types.CallRequest, epoch *types.EpochOrBlockHash) (result hexutil.Bytes, err error)
}
